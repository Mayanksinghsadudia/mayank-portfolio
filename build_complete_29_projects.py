...
items_data = [
    ...
    # 29. Web Template PDF
    {
        "id": "web-template-pdf",
        "category": "uiux",
        "title": "Web Template Design Documentation (PDF)",
...
full_projects_grid = f'''{filter_buttons}
...
print("Successfully generated all 29 project cards in index.html!")
